        ...
        return (
            <div className='container-fluid'>
                ...
                <div className="row ml-client-form-row">
                    ...
                    <h3 className="text-center">Daftar Kompetisi Band TECHNOFEST 2021</h3>
                        <form enctype="application/json">
                        <Input type="text" labelName="Nama Band" placeholder="Masukkan nama band anda disini..." name="band_name" onChange={handleChange}/>
